 <div class="container-fuild">
     <div class="row border">
         <div class="col-lg-3 sidebar p-0 bg-dark">
             <div class="title d-flex p-3">
                 <div class="img m-2">
                     <img src="<?= PUBLICS; ?>image/Untitled.jpg" style="height: 70px; border-radius:100%;" alt="">
                 </div>
                 <div class="user-name mt-3">
                     <h4 class="m-0 p-0">Praveen Kumawat <br> <span style="color: rgb(6, 204, 35); font-size:14px">Online</span></h4>
                 </div>
             </div>
             <div class="Genaral m-2 p-3">
                 <h5>Genaral</h5>
             </div>
             <div class="sidebar-links">
                 <div class="sidebar-items m-1 p-2">
                 ...
                 <div class="sidebar-items m-1 p-2">
                     ...
                     <a class="m-2" href="<?= ROOT; ?>department/"> Department</a>
                 </div>
                 <?php if (Session::get('logindtl')) { ?>
                     ...
                     <div class="sidebar-items m-1 p-2">
                         ...
                         <a class="m-2" href="<?= ROOT; ?>doctor"> Doctor</a>
                     </div>
                     <div class="sidebar-items m-1 p-2">
                         <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                     ...
                     <div class="sidebar-items m-1 p-2">
                         ...
                         <a class="m-2" href="<?= ROOT; ?>/login/logout"> Logout</a>
                     </div>
         ...
         <div class="col-sm-12 col-lg-9 m-0 p-0 ">
             <nav class="navbar nav bg-dark p-3 text-white">
                 <div class="burger m-0">
                     <a href=""><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                             <style>
                                 svg {
                                     fill: #ff7300
                                 }
                 ...
                 <div class="notification">
                     <a class="p-2" href=""><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                     ...
                     <a class="p-2" href=""><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                             <style>
                                 svg {
                                     fill: #ffd500
                                 }
